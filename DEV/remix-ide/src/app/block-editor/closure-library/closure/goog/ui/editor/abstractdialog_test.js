...
function testBasicLayout() {
  ...
  assertContains(
    "Dialog html should contain custom OK button label",
    ">The OK Button<",
    html
  )
  assertContains(
    "Dialog html should contain default Cancel button label",
    ">Cancel<",
    html
  )
  assertContains(
    "Dialog html should contain custom button label",
    ">The Apply Button<",
    html
  )
  assertTrue(
...
function testCustomButton() {
  ...
  assertNotOpen(
    "Dialog should not be open after clicking custom button",
    dialog
  )
...
function testOkReturnFalse() {
  ...
  goog.testing.events.fireClickSequence(dialog.getOkButtonElement())
  assertOpen(
    "Dialog should not be closed because handler returned false",
    dialog
  )
...
function testCreateOkEventFail() {
  ...
  goog.testing.events.fireClickSequence(dialog.getOkButtonElement())
  assertOpen(
    "Dialog should not be closed because OK event creation failed",
    dialog
  )
