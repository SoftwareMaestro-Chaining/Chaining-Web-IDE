...
function testGetWeekNumber() {
  ...
  assertEquals(
    "2006-01-01 is in week 52 of the following year",
    52,
    f(2006, goog.date.month.JAN, 1)
  )
  assertEquals("2006-01-02 is in week 1", 1, f(2006, goog.date.month.JAN, 2))
  assertEquals("2006-10-16 is in week 42", 42, f(2006, goog.date.month.OCT, 16))
  assertEquals("2006-10-19 is in week 42", 42, f(2006, goog.date.month.OCT, 19))
  assertEquals("2006-10-22 is in week 42", 42, f(2006, goog.date.month.OCT, 22))
  assertEquals("2006-10-23 is in week 43", 43, f(2006, goog.date.month.OCT, 23))
  assertEquals(
    "2008-12-29 is in week 1 of the following year",
    1,
    f(2008, goog.date.month.DEC, 29)
  )
  assertEquals(
    "2010-01-03 is in week 53 of the previous year",
    53,
    f(2010, goog.date.month.JAN, 3)
  )
  ...
  assertEquals(
    "2007-01-01 is in week 1 (cutoff=Monday)",
    1,
    f(2007, goog.date.month.JAN, 1, goog.date.weekDay.MON)
  )
  assertEquals(
    "2007-01-01 is in week 1 (cutoff=Sunday)",
    1,
...
function testGetYearOfWeek() {
  ...
  assertEquals(
    "2005-12-31 is the week 52 of current year",
    2005,
    f(2005, goog.date.month.DEC, 31)
  )
  assertEquals(
    "2007-01-01 is the week 1 of 2007",
    2007,
    f(2007, goog.date.month.JAN, 1)
  )
  assertEquals(
    "2007-12-30 is the week 52 of 2007",
    2007,
    f(2007, goog.date.month.DEC, 30)
  )
  assertEquals(
  ...
  assertEquals(
    "2008-01-01 is the week 1 of 2008",
    2008,
    f(2008, goog.date.month.JAN, 1)
  )
  assertEquals(
    "2008-12-28 is the week 52 of 2008",
    2008,
    f(2008, goog.date.month.DEC, 28)
  )
  assertEquals(
  ...
  assertEquals(
    "2009-01-01 is the week 1 of 2009",
    2009,
  ...
  assertEquals(
    "2010-01-04 is the week 1 of 2010",
    2010,
    f(2010, goog.date.month.JAN, 4)
  )

  assertEquals(
    "2006-01-01 is in week 52 of the perv. year",
    2005,
    f(2006, goog.date.month.JAN, 1)
  )
  assertEquals(
    "2006-01-02 is in week 1 of 2006",
    2006,
...
function testDateConstructor_yearBelow100() {
  ...
  assertEquals(
    "Date constructor should respect passed in full year",
    14,
    date.getFullYear()
  )
  ...
  assertEquals(
    "Copying a should return identical date",
    date.getTime(),
    copied.getTime()
  )
  assertEquals(
    "Full year should be left intact by copying",
    14,
    copied.getFullYear()
  )
...
function test_setIso8601TimeOnly_() {
  ...
  try {
    if (goog.userAgent.WEBKIT && goog.userAgent.MAC) {
      ...
      assertRoughlyEquals(
        "Got roughly 994.2 milliseconds from " + iso,
        994.2,
        d.getMilliseconds(),
        0.01
      )
...
function testIsoDuration() {
  ...
  assertEquals(
    "create full negative duration",
    duration5,
    interval5.toIsoString()
  )
  ...
  assertEquals(
    "create partial negative duration",
    duration6,
    interval6.toIsoString()
  )
  assertEquals(
  ...
  assertEquals(
    "create partial one-digit duration",
    duration7,
...
function testDateTimezone() {
  ...
  d.add(
    new goog.date.Interval(goog.date.Interval.MINUTES, d.getTimezoneOffset())
  )
...
function testToUsTimeString() {
  ...
  assertEquals(
    "omit zero 1",
    "6:00 PM",
    d.toUsTimeString(dontPad, doShowPm, false)
  )
  ...
  assertEquals(
    "omit zero 4",
    "6:01 PM",
    d.toUsTimeString(dontPad, doShowPm, true)
  )
}
...
function testDateCompare() {
  ...
  var date1 = new goog.date.DateTime(
    2011,
    goog.date.month.MAY,
    16,
    15,
  ...
  var date2 = new goog.date.DateTime(
    2011,
    goog.date.month.MAY,
    16,
    15,
  ...
  // May 16th, 2011, 3:17:36.501
  var date3 = new goog.date.DateTime(
    2011,
    goog.date.month.MAY,
    16,
    15,
  ...
  assertArrayEquals(
    "Dates should be sorted in time.",
    [date1, date2, date3],
    dates
  )
  ...
  assertEquals(
    ...
    goog.date.Date.compare(
      ...
      new goog.date.DateTime(1982, goog.date.month.MAR, 12, 12, 7, 21, 832)
    )
  )
...
function testDateCompareDateLikes() {
  ...
  var closureDate = new goog.date.DateTime(
    2011,
    goog.date.month.MAY,
    16,
    15,
