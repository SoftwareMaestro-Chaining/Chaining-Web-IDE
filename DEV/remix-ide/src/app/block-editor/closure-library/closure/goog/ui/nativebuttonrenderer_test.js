...
function testCreateDom() {
  ...
  assertEquals(
    ...
    String(goog.dom.TagName.BUTTON),
    element.tagName
  )
  assertSameElements(
  ...
  try {
    ...
    assertEquals(
      "Button element must have expected contents",
      "Hello",
      element.innerHTML
    )
  } catch (e) {
...
function testDecorate() {
  ...
  assertEquals(
    "Decorated element must be as expected",
    goog.dom.getElement("foo"),
    element
  )
  assertEquals(
    "Decorated button title must have expected value",
    "Hello!",
    button.getTooltip()
  )
  // Expected to fail on IE.
  ...
  try {
    ...
    // for a description of the problem.
    assertEquals(
      "Decorated button value must have expected value",
      "bar",
      button.getValue()
    )
  } catch (e) {
...
function testIsFocusable() {
  ...
  assertFalse(
    "Disabled button must not be focusable",
...
function testSetState() {
  button.render(sandbox)
  assertFalse(
    "Button element must not be disabled",
