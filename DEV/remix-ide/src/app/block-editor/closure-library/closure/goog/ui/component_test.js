...
function testConstructor() {
  ...
  assertEquals(
    "DOM helper must refer to expected object",
    fakeDom,
    otherComponent.dom_
  )
...
function testGetId() {
  ...
  assertEquals(
    "Subsequent calls to getId() must return same value",
    id,
    component.getId()
  )
}
...
function testSetId() {
  ...
  assertEquals(
    "getId() must return explicitly set ID",
    "myId",
    component.getId()
  )
  ...
  assertEquals(
    "Parent component must find child by ID",
    child,
...
function testGetSetElement() {
  ...
  assertEquals(
    "getElement() must return expected element",
    element,
...
function testGetSetParent() {
  ...
  assertEquals(
    "getParent() must return expected component",
    parent,
    component.getParent()
  )
...
function testRender() {
  ...
  assertTrue(
    "Rendered component must be in the document",
    component.isInDocument()
  )
  assertEquals(
...
function testRender_ParentNotInDocument() {
  ...
  assertFalse(
    "Parent component must not be in the document",
    parent.isInDocument()
  )
  assertFalse(
...
function testDecorate() {
  ...
  assertFalse(
    "wasDecorated() must be false by default",
    component.wasDecorated()
  )
  ...
  assertTrue("Component must be in the document", component.isInDocument())
  assertEquals(
    "Component's element must be the decorated element",
    foo,
    component.getElement()
  )
  assertTrue(
...
function testDispose_Decorated() {
  ...
  assertTrue("Component must be in the document", component.isInDocument())
  assertFalse(
    "Component must not have been disposed of",
    component.isDisposed()
  )
  assertEquals(
    "Component's element must have expected value",
    foo,
    component.getElement()
  )
  assertEquals(
    "Decorated element must be a child of the sandbox",
    sandbox,
    foo.parentNode
  )
...
function testGetChild() {
  ...
  assertEquals(
    "Parent must find child by new ID",
    c,
...
function testRemoveChild() {
  ...
  assertEquals(
    "Parent must remove and return child",
    c,
    component.removeChild(c)
  )
  assertNull(
    "Parent must no longer contain this child",
    component.getChild("c")
  )

  assertEquals(
    "Parent must remove and return child by ID",
    b,
  ...
  assertEquals(
    "Parent must remove and return child by index",
    a,
    component.removeChildAt(0)
  )
  assertNull(
