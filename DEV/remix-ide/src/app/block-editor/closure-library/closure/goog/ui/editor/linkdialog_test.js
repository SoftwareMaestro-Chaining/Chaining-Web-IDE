...
function expectOk(linkText, linkUrl, opt_openInNewWindow, opt_noFollow) {
  mockOkHandler.handleEvent(
    new goog.testing.mockmatchers.ArgumentMatcher(function(arg) {
      return (
        arg.type == goog.ui.editor.AbstractDialog.EventType.OK &&
...
function testShowForNewLink(opt_document) {
  ...
  assertEquals(
    "Display text input field should be empty",
    "",
    getDisplayInputText()
  )
  assertEquals("Url input field should be empty", "", getUrlInputText())
  assertEquals(
    "On the web tab should be selected",
...
function testShowForUrlLink() {
  ...
  assertEquals(
    "Url input field should be filled in",
    ANCHOR_URL,
    getUrlInputText()
  )
  assertEquals(
...
function testAutogeneration() {
  ...
  assertEquals(
    "Display text should have been autogenerated",
    ANCHOR_URL,
    getDisplayInputText()
  )
  ...
  assertEquals(
    "Display text should have remained the same",
    ANCHOR_TEXT,
    getDisplayInputText()
  )
...
function testSetTextToDisplayVisible() {
  ...
  assertEquals("none", goog.style.getStyle(dialog.textToDisplayDiv_, "display"))
