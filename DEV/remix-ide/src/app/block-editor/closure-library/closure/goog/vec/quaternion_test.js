...
function testSlerp() {
  ...
  goog.vec.Quaternion.slerp(q0, q0, 0.5, q2)
  ...
  goog.vec.Quaternion.slerp(q0, q1, 0.3, q2)
  assertElementsRoughlyEqual(
  ...
  goog.vec.Quaternion.slerp(q0, q1, 0.5, q2)
  assertElementsRoughlyEqual(
  ...
  goog.vec.Quaternion.slerp(q0, q1, 0.8, q0)
  assertElementsRoughlyEqual(
...
function testFromRotMatrix() {
  ...
  assertElementsRoughlyEqual(
    [0, -0.87872350215912, 0, 0.477331042289734],
    q1,
    goog.vec.EPSILON
  )
...
function testFromAngleAxis() {
  ...
  var angle = 0.0
  var axis = goog.vec.Vec3.createFloat32FromValues(
    -0.408248,
    0.8796528,
    -0.244016
  )
