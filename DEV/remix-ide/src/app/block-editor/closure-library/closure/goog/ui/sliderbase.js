 ...
 * @private
 */
goog.ui.SliderBase.SLIDER_DRAGGING_CSS_CLASS_ = goog.getCssName(
  "goog-slider-dragging"
);
 ...
 * @private
 */
goog.ui.SliderBase.THUMB_DRAGGING_CSS_CLASS_ = goog.getCssName(
 ...
 * @private
 */
goog.ui.SliderBase.DISABLED_CSS_CLASS_ = goog.getCssName(
...
goog.ui.SliderBase.prototype.handleMouseDownAndClick_ = function(e) {
  ...
  if (
    !goog.dom.contains(this.valueThumb, target) &&
