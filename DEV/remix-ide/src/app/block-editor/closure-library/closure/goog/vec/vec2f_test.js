...
function testMultiply() {
  ...
  goog.vec.vec2f.componentMultiply(
    goog.vec.vec2f.componentMultiply(v0, v1, v2),
    v0,
    v2
  )
...
function testDivide() {
  ...
  goog.vec.vec2f.componentDivide(
    goog.vec.vec2f.componentDivide(v1, v0, v2),
    v0,
    v2
  )
...
function testNormalize() {
  ...
  goog.vec.vec2f.scale(v0, 1 / goog.vec.vec2f.magnitude(v0), v2)
...
function testLerp() {
  ...
  goog.vec.vec2f.lerp(v0, v1, 0.5, v2)
