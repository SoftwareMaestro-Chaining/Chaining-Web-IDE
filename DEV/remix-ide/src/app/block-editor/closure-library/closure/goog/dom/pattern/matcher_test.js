...
function testMatcherAndStartTagTwice() {
  ...
  assertEquals(
    "StartTag(p) should match 5 times in body again",
    5,
    counter.count
  )
}
...
function testMatcherAndStartTagAttributes() {
  ...
  assertEquals(
    "StartTag(span,id) should match 2 times in body",
    2,
    counter.count
  )
}
...
function testMatcherWithTwoPatterns() {
  ...
  assertEquals(
    "StartTag(span|p) should match 8 times in body",
    8,
    counter.count
  )
}
...
function testMatcherAndRepeatFullTag() {
  var pattern = new goog.dom.pattern.Repeat(
    new goog.dom.pattern.FullTag("P"),
    1
  )
