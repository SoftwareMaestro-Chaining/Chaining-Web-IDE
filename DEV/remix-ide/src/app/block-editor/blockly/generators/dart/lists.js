...
Blockly.Dart["lists_getSublist"] = function(block) {
  ...
  if (list.match(/^\w+$/) || (where1 != "FROM_END" && where2 == "FROM_START")) {
    ...
    var functionName = Blockly.Dart.provideFunction_("lists_get_sublist", [
      "List " +
        Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ +
...
Blockly.Dart["lists_sort"] = function(block) {
  ...
  var sortFunctionName = Blockly.Dart.provideFunction_("lists_sort", [
    "List " +
      Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ +
      "(list, type, direction) {",
    "  var compareFuncs = {",
...
Blockly.Dart["lists_split"] = function(block) {
  ...
  var input = Blockly.Dart.valueToCode(
    block,
    "INPUT",
    Blockly.Dart.ORDER_UNARY_POSTFIX
  )
