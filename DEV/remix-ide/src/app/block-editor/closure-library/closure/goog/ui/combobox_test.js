...
function testUpKeyCausesPopup() {
  ...
  assertTrue(
    "Menu becomes visible after UP key",
...
function testRedisplayMenuAfterBackspace() {
  ...
  comboBox.onInputEvent_()
  assertEquals(
    "Three items should be displayed",
    3,
...
function testSetEnabled() {
  ...
  assertTrue(
    "Text input should be disabled after being disabled",
    input.disabled
  )
  assertTrue(
