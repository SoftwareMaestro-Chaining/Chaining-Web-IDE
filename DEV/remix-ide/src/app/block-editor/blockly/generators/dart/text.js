...
Blockly.Dart["text_getSubstring"] = function(block) {
  ...
  if (where1 == "FIRST" && where2 == "LAST") {
    ...
    var functionName = Blockly.Dart.provideFunction_("text_get_substring", [
      "List " +
        Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ +
...
Blockly.Dart["text_changeCase"] = function(block) {
  ...
  if (operator) {
    ...
    var functionName = Blockly.Dart.provideFunction_("text_toTitleCase", [
...
Blockly.Dart["text_count"] = function(block) {
  ...
  var functionName = Blockly.Dart.provideFunction_("text_count", [
    "int " +
      Blockly.Dart.FUNCTION_NAME_PLACEHOLDER_ +
