...
function testProvide() {
  ...
  assertNotUndefined(
    "provide failed: goog.test.name.space",
...
function testIsArrayLike() {
  ...
  assertFalse(
    "undefined should not be array-like",
...
function testRemoveUidFromPlainObject() {
  ...
  goog.removeUid(a)
  assertNotEquals(
    "An object's old and new unique IDs should be different",
    uid,
    goog.getUid(a)
  )
}
...
function testConstructorUid() {
  ...
  assertNotEquals(
    "Unique IDs of BaseClass and SubClass must differ",
    baseClassUid,
    subClassUid
  )
  assertNotEquals(
...
function testWindowUid() {
  ...
  assertNotEquals(
    "generates new id after the old one is removed",
    goog.getUid(window)
  )
}
...
function testInherits_constructor() {
  ...
  assertEquals(
    "constructor property should match constructor function",
    Bar,
    bar.constructor
  )
  assertEquals(
...
function testDefineClass_seals() {
  ...
  try {
    a.foo = "bar"
  } catch (expectedInStrictModeOnly) {
    /* ignored */
  }
...
function testLoadFileSync() {
  ...
  assertTrue(
    "goog.loadFileSync_ returns string",
