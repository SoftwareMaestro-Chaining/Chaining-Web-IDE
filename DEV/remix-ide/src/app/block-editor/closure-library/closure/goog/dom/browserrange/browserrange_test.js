...
function testCreateFromNodes() {
  ...
  assertEquals(
    "Start node should be selected at start endpoint",
    start,
    range.getStartNode()
  )
  ...
  assertTrue(
    'Text content should be "xt\\s*ab"',
...
function testTextNode() {
  ...
  assertEquals(
    "Selection should end at offset 4",
    "Text".length,
    range.getEndOffset()
  )

  assertEquals(
    "Container should be text node",
...
function testTextNodes() {
  ...
  assertEquals(
    "Selection should end at offset 5",
    "Part2".length,
    range.getEndOffset()
  )
  ...
  assertEquals(
    'Text content should be "Part1Part2"',
    "Part1Part2",
    range.getText()
  )
  assertFalse("Text range is not collapsed", range.isCollapsed())
...
function testDiv() {
  ...
  assertEquals(
    "Selection should end at offset 3",
    "def".length,
    range.getEndOffset()
  )
...
function testEmptyNodeHtmlInsert() {
  ...
  var html = "<b>hello</b>"
  range.insertNode(
    goog.dom.safeHtmlToNode(goog.html.testing.newSafeHtmlForTest(html))
  )
  assertEquals(
    "Html is not inserted correctly",
    html,
...
function testRemoveContentsEmptyNode() {
  ...
  assertTrue("Removed range is now collapsed", range.isCollapsed())
  assertEquals(
    "Outer div should have 0 children now",
    0,
...
function testRemoveDivCaretRange() {
  ...
  range.removeContents()
  range.insertNode(
    goog.dom.createDom(goog.dom.TagName.SPAN, undefined, "Hello"),
    true
  )
...
function testCollapse() {
  ...
  range.collapse()
  assertTrue(
    "Div range is collapsed after call to empty()",
    range.isCollapsed()
  )
...
function testGetContainerInTextNodesAroundEmptySpan() {
  ...
  assertEquals(
    "textNode abc should be the range container",
    abc,
    range.getContainer()
  )
  assertEquals(
    "textNode abc should be the range start node",
    abc,
    range.getStartNode()
  )
  assertEquals(
    "textNode abc should be the range end node",
    abc,
    range.getEndNode()
  )
  ...
  assertEquals(
    "textNode def should be the range container",
    def,
    range.getContainer()
  )
  assertEquals(
    "textNode def should be the range start node",
    def,
    range.getStartNode()
  )
  assertEquals(
    "textNode def should be the range end node",
    def,
    range.getEndNode()
  )
}
