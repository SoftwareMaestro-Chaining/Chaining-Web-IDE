...
goog.ui.DatePicker = function(
   ...
   */
  this.symbols_ =
    /** @type {!goog.i18n.DateTimeSymbolsType} */ (opt_dateTimeSymbols ||
  ...
  this.i18nDateFormatterDay2_ = new goog.i18n.DateTimeFormat(
    "dd",
    this.symbols_
  )
  ...
  this.i18nDateFormatterDayAriaLabel_ = new goog.i18n.DateTimeFormat(
    "d MMM",
    this.symbols_
  )
  ...
  this.i18nDateFormatterYear_ = new goog.i18n.DateTimeFormat(
    patYear,
    this.symbols_
  )
  var patMMMMy = goog.i18n.DateTimePatterns.YEAR_MONTH_FULL || "MMMM y"
  this.i18nDateFormatterMonthYear_ = new goog.i18n.DateTimeFormat(
    patMMMMy,
    this.symbols_
  )
...
goog.ui.DatePicker.prototype.decorateInternal = function(el) {
  ...
  var table = this.dom_.createDom(goog.dom.TagName.TABLE, {
    role: "presentation"
  })
...
goog.ui.DatePicker.prototype.createMenu_ = function(
  ...
  this.menuSelected_.className = goog.getCssName(
    this.getBaseCssClass(),
    "menu-selected"
  )
...
goog.ui.DatePicker.prototype.redrawCalendarGrid_ = function() {
  ...
  for (var y = 0; y < 6; y++) {
    ...
    if (y >= 4) {
      var parentEl =
        /** @type {Element} */ (this.elTable_[y + 1][0].parentElement ||
...
goog.ui.DatePicker.prototype.redrawWeekdays_ = function() {
  ...
  var parentEl =
    /** @type {Element} */ (this.elTable_[0][0].parentElement ||
