...
function testConstructor() {
  ...
  assertEquals(
    "Content must have expected content",
    "Hello",
...
function testGetSetContent() {
  ...
  assertEquals(
    "Textarea element must have expected content",
    "17",
    textarea.getElement().value
  )
  textarea.setContent("foo")
  assertEquals(
    "Textarea element must have updated content",
    "foo",
    textarea.getElement().value
  )
}
...
function testBasicTextareaBehavior() {
  ...
  assertTrue(
    "Textarea should shrink with no content.",
    heightAfter <= heightBefore
  )
  assertTrue(
    "With a height change, a resize event should have fired.",
...
function testMinHeight() {
  ...
  assertEquals(
    "offsetHeight should be 50 initially",
    50,
