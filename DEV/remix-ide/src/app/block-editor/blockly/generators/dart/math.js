...
Blockly.Dart["math_number_property"] = function(block) {
  ...
  var number_to_check = Blockly.Dart.valueToCode(
    block,
    "NUMBER_TO_CHECK",
    Blockly.Dart.ORDER_MULTIPLICATIVE
  )
  ...
  if (dropdown_property == "PRIME") {
    ...
    Blockly.Dart.definitions_["import_dart_math"] =
      "import 'dart:math' as Math;"
    var functionName = Blockly.Dart.provideFunction_("math_isPrime", [
...
Blockly.Dart["math_change"] = function(block) {
  ...
  var argument0 =
    Blockly.Dart.valueToCode(block, "DELTA", Blockly.Dart.ORDER_ADDITIVE) || "0"
  var varName = Blockly.Dart.variableDB_.getName(
...
Blockly.Dart["math_random_int"] = function(block) {
  ...
  var functionName = Blockly.Dart.provideFunction_("math_random_int", [
