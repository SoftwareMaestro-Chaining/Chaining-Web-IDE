  ...
  if (operator == "SIN" || operator == "COS" || operator == "TAN") {
    arg =
      Blockly.Solidity.valueToCode(
        block,
        "NUM",
        Blockly.Solidity.ORDER_DIVISION
      ) || "0"
  } else {
    arg =
      Blockly.Solidity.valueToCode(block, "NUM", Blockly.Solidity.ORDER_NONE) ||
      "0"
  }
...
Blockly.Solidity["math_number_property"] = function(block) {
  ...
  var number_to_check =
    Blockly.Solidity.valueToCode(
      block,
      "NUMBER_TO_CHECK",
      Blockly.Solidity.ORDER_MODULUS
    ) || "0"
  var dropdown_property = block.getFieldValue("PROPERTY")
  var code
  if (dropdown_property == "PRIME") {
    // Prime is a special case as it is not a one-liner test.
    var functionName = Blockly.Solidity.provideFunction_("mathIsPrime", [
...
Blockly.Solidity["math_on_list"] = function(block) {
  ...
  switch (func) {
    ...
    case "AVERAGE":
      ...
      var functionName = Blockly.Solidity.provideFunction_("mathMean", [
        "function " +
          Blockly.Solidity.FUNCTION_NAME_PLACEHOLDER_ +
          "(myList) {",
    ...
    case "MEDIAN":
      ...
      var functionName = Blockly.Solidity.provideFunction_("mathMedian", [
        "function " +
          Blockly.Solidity.FUNCTION_NAME_PLACEHOLDER_ +
          "(myList) {",
    ...
    case "MODE":
      ...
      var functionName = Blockly.Solidity.provideFunction_("mathModes", [
        "function " +
          Blockly.Solidity.FUNCTION_NAME_PLACEHOLDER_ +
          "(values) {",
        "  var modes = [];",
    ...
    case "STD_DEV":
      ...
      break
    case "RANDOM":
      var functionName = Blockly.Solidity.provideFunction_("mathRandomList", [
        "function " + Blockly.Solidity.FUNCTION_NAME_PLACEHOLDER_ + "(list) {",
...
Blockly.Solidity["math_constrain"] = function(block) {
  ...
  var argument1 =
    Blockly.Solidity.valueToCode(block, "LOW", Blockly.Solidity.ORDER_COMMA) ||
    "0"
  var argument2 =
    Blockly.Solidity.valueToCode(block, "HIGH", Blockly.Solidity.ORDER_COMMA) ||
    "Infinity"
  var code =
    "Math.min(Math.max(" +
    argument0 +
...
Blockly.Solidity["math_random_int"] = function(block) {
  ...
  var argument0 =
    Blockly.Solidity.valueToCode(block, "FROM", Blockly.Solidity.ORDER_COMMA) ||
    "0"
  var argument1 =
    Blockly.Solidity.valueToCode(block, "TO", Blockly.Solidity.ORDER_COMMA) ||
    "0"
  var functionName = Blockly.Solidity.provideFunction_("mathRandomInt", [
    "function " + Blockly.Solidity.FUNCTION_NAME_PLACEHOLDER_ + "(a, b) {",
    "  if (a > b) {",
