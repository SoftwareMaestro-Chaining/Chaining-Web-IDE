...
function testSelect() {
  ...
  assertEquals(
    "Control range should be selected",
    "Control",
    document.selection.type
  )
  assertEquals(
    "Control range should have length 1",
    1,
    document.selection.createRange().length
  )
  assertEquals(
    "Control range should select table",
    table,
...
function testGetContainer() {
  ...
  assertEquals(
    "Single element range is contained by itself",
    logo,
    range.getContainer()
  )
  ...
  assertEquals(
    "Two element range is contained by body",
    document.body,
    range.getContainer()
  )
}
