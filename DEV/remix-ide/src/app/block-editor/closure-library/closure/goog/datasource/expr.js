...
goog.ds.Expr.prototype.setSource_ = function(
  ...
  if (!opt_childExpr && !opt_prevExpr) {
    ...
    if (goog.string.endsWith(expr, "()")) {
      if (
        goog.string.endsWith(expr, goog.ds.Expr.String_.NAME_EXPR) ||
  ...
  if (this.size_ == 1 && !this.isAbsolute_) {
    ...
    this.isJustAttribute_ = goog.string.startsWith(
      expr,
...
goog.ds.Expr.prototype.getNext = function() {
  if (!this.nextExprSet_) {
    if (this.size_ > 1) {
      this.nextExpr_ = goog.ds.Expr.createInternal_(
        null,
        this.parts_.slice(1),
        null,
        this
...
goog.ds.Expr.prototype.getNodes = function(opt_ds, opt_canCreate) {
  return /** @type {goog.ds.DataNodeList} */ (this.getNodes_(
    opt_ds,
    false,
    opt_canCreate
  ))
...
goog.ds.Expr.prototype.getNode = function(opt_ds, opt_canCreate) {
  return /** @type {goog.ds.DataNode} */ (this.getNodes_(
    opt_ds,
    true,
    opt_canCreate
  ))
 ...
 */
goog.ds.Expr.ALL_CHILD_NODES = goog.ds.Expr.create(
 ...
 */
goog.ds.Expr.ALL_ELEMENTS = goog.ds.Expr.create(
 ...
 */
goog.ds.Expr.ALL_ATTRIBUTES = goog.ds.Expr.create(
