...
goog.ui.Control.getDecorator =
  /** @type {function(Element): goog.ui.Control} */ (goog.ui.registry.getDecorator)
...
goog.ui.Control.prototype.isParentDisabled_ = function() {
  ...
  return (
    !!parent && typeof parent.isEnabled == "function" && !parent.isEnabled()
  )
}
...
goog.ui.Control.prototype.isDispatchTransitionEvents = function(state) {
  return (
    !!(this.statesWithTransitionEvents_ & state) && this.isSupportedState(state)
  )
}
...
goog.ui.Control.prototype.handleKeyEventInternal = function(e) {
  return (
    e.keyCode == goog.events.KeyCodes.ENTER && this.performActionInternal(e)
  )
}
