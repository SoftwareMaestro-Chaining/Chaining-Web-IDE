...
function testBuildFromEncodedParts() {
  ...
  assertEquals(
    ...
    utils.buildFromEncodedParts(
      new HasString("http"),
      new HasString("foo"),
      new HasString("www.google.com"),
      new HasString("80"),
      new HasString("/path"),
      new HasString("q=query"),
...
function testAppendParams() {
  ...
  assertEquals(
    ...
    utils.appendParams("http://foo.com?a=1#preserve", "q", 1, "r", 2, "s", [
      3,
      4
    ])
  )
  ...
  assertEquals(
    ...
    utils.appendParams("http://foo.com", "q", new HasString("a"), "r", [
      new HasString("b")
    ])
  )
...
function testAppendParamsAsArray() {
  ...
  assertEquals(
    ...
    utils.appendParams("http://foo.com#preserve", [
      ...
      2,
      "s",
      [3, new HasString("4"), null, undefined]
    ])
  )
}
...
function testSetParamsFromMap() {
  ...
  assertEquals(
    ...
    goog.uri.utils.setParamsFromMap("http://foo.com/bar?a=1&b=2&c=3#b=5", {
      a: null,
      c: undefined
    })
  )
  assertEquals(
    "remove all params",
    "http://foo.com#b=5",
    goog.uri.utils.setParamsFromMap("http://foo.com?a=1&b=2&c=3#b=5", {
      a: null,
      b: null,
      c: undefined
    })
  ...
  assertEquals(
    ...
    goog.uri.utils.setParamsFromMap("http://foo.com?a=1&b=2&c=3", {
      a: 999,
      c: null
    })
  )
  assertEquals(
    ...
    goog.uri.utils.setParamsFromMap("http://foo.com?a=1&b=2&b=20&b", { a: 999 })
  )
  assertEquals(
  ...
  assertUriEquals(
    ...
    goog.uri.utils.setParamsFromMap("http://foo.com?a=1&b=2&b=20&c=3&d=4", {
      a: 100,
      b: 200,
      c: 300
    })
  ...
  assertUriEquals(
    ...
    goog.uri.utils.setParamsFromMap("http://foo.com?a=1&b=2&b=20&c=3", {
      a: 100,
      b: null,
      d: 400
    })
...
function testParseQuery() {
  ...
  // result.
  var result2 = []
  goog.uri.utils.parseQueryData(goog.uri.utils.buildQueryData(result), function(
    name,
    value
  ) {
