...
function testOrientationChange() {
  ...
  popup.resizeBackgroundTask_ = function() {
    i++
  }
  popup.render()
...
function testEventFiredOnShow() {
  ...
  var showHandler = function() {
    assertEquals(
      "BEFORE_SHOW is not dispatched before SHOW",
      1,
      beforeShowCallCount
    )
    showCallCount++
...
function testEventFiredOnHide() {
  ...
  var hideHandler = function() {
    assertEquals(
      "BEFORE_HIDE is not dispatched before HIDE",
      1,
      beforeHideCallCount
    )
    hideCallCount++
...
function testTransitionsAndDisposingOnHideWorks() {
  ...
  var bgShowTransition = goog.fx.css3.fadeIn(
    popup.getElement(),
    0.1 /* duration */
  )
  var bgHideTransition = goog.fx.css3.fadeOut(
    popup.getElement(),
    0.1 /* duration */
  )
