...
goog.ui.editor.DefaultToolbar.MSG_FONT_NORMAL_SERIF = goog.getMsg(
  "Normal / serif"
)
...
goog.ui.editor.DefaultToolbar.addDefaultFonts = function(button) {
  ...
  var locale = goog.ui.editor.DefaultToolbar.locale_
    .replace(/_/, "-")
    .toLowerCase()
...
goog.ui.editor.DefaultToolbar.MSG_FORMAT_MINOR_HEADING = goog.getMsg(
  "Minor heading"
)
...
goog.ui.editor.DefaultToolbar.fontFaceFactory_ = function(
  ...
  button.updateFromValue = function(value) {
    ...
    if (value && value.length > 0) {
      item = /** @type {goog.ui.MenuItem} */ (button
        .getMenu()
        .getChild(goog.ui.editor.ToolbarFactory.getPrimaryFont(value)))
    }
...
goog.ui.editor.DefaultToolbar.MSG_BACKGROUND_COLOR_TITLE = goog.getMsg(
...
goog.ui.editor.DefaultToolbar.MSG_ORDERED_LIST_TITLE = goog.getMsg(
  "Numbered list"
)

/** @desc Bullet list button tooltip. */
goog.ui.editor.DefaultToolbar.MSG_UNORDERED_LIST_TITLE = goog.getMsg(
  "Bullet list"
)
...
goog.ui.editor.DefaultToolbar.MSG_ALIGN_CENTER_TITLE = goog.getMsg(
  "Align center"
)
...
goog.ui.editor.DefaultToolbar.MSG_REMOVE_FORMAT_TITLE = goog.getMsg(
  "Remove formatting"
)
...
goog.ui.editor.DefaultToolbar.MSG_STRIKE_THROUGH_TITLE = goog.getMsg(
  "Strikethrough"
)
...
goog.ui.editor.DefaultToolbar.MSG_EDIT_HTML_TITLE = goog.getMsg(
  "Edit HTML source"
)
...
;(function() {
  ...
  for (
    var i = 0, button;
    (button = goog.ui.editor.DefaultToolbar.button_list_[i]);
    i++
  ) {
