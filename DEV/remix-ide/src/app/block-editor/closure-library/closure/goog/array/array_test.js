...
function testArrayForEachWithOnlySomeValuesAsigned() {
  ...
  assertEquals(
    "Should only call function when a value of array was assigned.",
    1,
    count
  )
}
...
function testArrayInsertAt() {
  ...
  assertArrayEquals(
    "insertAt, too large value should append",
    [0, 1, 4, 2, 3, 5],
    a
  )
  ...
  assertArrayEquals(
    "insertAt, negative values start from end",
    [6, 0, 1, 4, 2, 7, 3, 5],
    a
  )
}
...
function testArrayInsertArrayAt() {
  ...
  assertArrayEquals(
    "insertArrayAt, insert one element",
    [0, 1, 2, 3, "x", 4, 5, 6, 7],
    a
  )
  goog.array.insertArrayAt(a, [], 4)
  assertArrayEquals(
    "insertArrayAt, insert 0 elements",
    [0, 1, 2, 3, "x", 4, 5, 6, 7],
    a
  )
...
function testArrayInsertBefore() {
  ...
  assertArrayEquals(
    "insertBefore, with existing element",
    ["a", "e", "b", "c", "d"],
    a
  )
...
function testBinarySearch() {
  ...
  assertEquals(
    "'1000' should be found at index 0",
    0,
  ...
  assertEquals(
    "'100' should have an insertion point of 0",
    0,
    insertionPoint(pos)
  )
  ...
  assertEquals(
    "'BA' should have an insertion point of 10",
    10,
    insertionPoint(pos)
  )
  ...
  assertEquals(
    "'a' should have an insertion point of 0",
    0,
    insertionPoint(pos)
  )
  ...
  assertEquals(
    "'z' should have an insertion point of 1",
    1,
    insertionPoint(pos)
  )
  ...
  assertEquals(
    "-897123.9 should be found at index 0",
    0,
  ...
  assertEquals(
    "-3 should be found at index 5",
    5,
    goog.array.binarySearch(d, -3)
  )
  ...
  assertEquals(
    "-900000 should have an insertion point of 0",
    0,
    insertionPoint(pos)
  )
  ...
  assertEquals(
    "1.1 should have an insertion point of 10",
    10,
    insertionPoint(pos)
  )
  ...
  assertEquals(
    "54254.1 should have an insertion point of 0",
    0,
    insertionPoint(pos)
  )
  ...
  assertTrue("1.1 should not be found", pos < 0)
  assertEquals(
    "1.1 should have an insertion point of 6",
    6,
    insertionPoint(pos)
  )
...
function testBinarySelect() {
  ...
  var objects = goog.array.map(numbers, function(n) {
    return { n: n }
  })
  ...
  assertEquals(
    "{n:-900000} should have an insertion point of 0",
    0,
    insertionPoint(pos)
  )
  ...
  assertEquals(
    "{n:1.1} should have an insertion point of 10",
    10,
    insertionPoint(pos)
  )
}
...
function testSort() {
  ...
  goog.array.sort(a)
  assertEquals(
    "Sorted empty array is still an empty array (length 0)",
    0,
    a.length
  )
  ...
  goog.array.sort(f, function(a, b) {
    return b - a
  })
...
function testStableSort() {
  ...
  for (var i = 0; i < arrClone.length; i++) {
    arr2.push({
      val: arrClone[i].val,
      toString: goog.partial(function(index) {
...
function testSortObjectsByKey() {
  ...
  var objects = [sortedArray[1], sortedArray[2], sortedArray[0], sortedArray[3]]
...
function testConcatMap() {
  ...
  var timesCalled = 0
  var result = goog.array.concatMap(
    a,
    function(val, index, a2) {
      assertEquals(a, a2)
      assertEquals(context, this)
