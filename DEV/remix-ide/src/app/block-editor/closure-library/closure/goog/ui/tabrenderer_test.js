...
function testGetAriaRole() {
  assertEquals(
    "ARIA role must have expected value",
...
function testDecorate() {
  ...
  assertEquals(
    "Decorated tab must have expected tooltip",
    "Yes",
    tab.getTooltip()
  )
  assertEquals(
    "Decorated element must have expected title",
    "Yes",
