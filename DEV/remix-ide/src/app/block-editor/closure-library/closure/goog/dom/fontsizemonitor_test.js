...
function testCreateAndDispose() {
  ...
  var iframeElementCount = goog.dom.getElementsByTagName(
    goog.dom.TagName.IFRAME
  ).length
  var divElementCount = goog.dom.getElementsByTagName(goog.dom.TagName.DIV)
    .length
  ...
  var newIframeElementCount = goog.dom.getElementsByTagName(
    goog.dom.TagName.IFRAME
  ).length
  var newDivElementCount = goog.dom.getElementsByTagName(goog.dom.TagName.DIV)
    .length

  assertEquals(
    "There should be no trailing frames",
    frameCount + isBuggyGecko(),
    newFrameCount
  )
  assertEquals(
  ...
  assertEquals(
    "There should be no trailing div elements",
    divElementCount,
    newDivElementCount
  )
}
...
function testWithDomHelper() {
  ...
  var iframeElementCount2 = goog.dom.getElementsByTagName(
    goog.dom.TagName.IFRAME,
    doc
  ).length
  var divElementCount2 = goog.dom.getElementsByTagName(
  ...
  var newIframeElementCount2 = goog.dom.getElementsByTagName(
    goog.dom.TagName.IFRAME,
    doc
  ).length
  var newDivElementCount2 = goog.dom.getElementsByTagName(
    goog.dom.TagName.DIV,
    doc
  ).length
