...
function testSetDate() {
  ...
  goog.events.listen(picker, goog.ui.DatePicker.Events.SELECT, function() {
    selectEvents++
  })
  goog.events.listen(picker, goog.ui.DatePicker.Events.CHANGE, function() {
    changeEvents++
  })
  goog.events.listen(
    picker,
  ...
  assertEquals(
    "no change active month event dispatched",
    1,
    changeActiveMonthEvents
  )
  assertTrue(
  ...
  assertEquals(
    "2 change active month events dispatched",
    1,
    changeActiveMonthEvents
  )
  ...
  assertEquals(
    "3 change active month event dispatched",
    2,
    changeActiveMonthEvents
  )
...
function testChangeActiveMonth() {
  ...
  picker.nextMonth()
  assertEquals(
    "1 change active month event dispatched",
    2,
    changeActiveMonthEvents
  )
  assertTrue(
  ...
  assertEquals(
    "3 change active month events dispatched",
    4,
    changeActiveMonthEvents
  )
  ...
  picker.previousYear()
  assertEquals(
    "4 change active month events dispatched",
    5,
    changeActiveMonthEvents
  )
}
...
function testUserSelectableDates() {
  var dateRange = new goog.date.DateRange(
    new goog.date.Date(2010, 1, 25),
    new goog.date.Date(2010, 1, 27)
  )
  picker = new goog.ui.DatePicker()
