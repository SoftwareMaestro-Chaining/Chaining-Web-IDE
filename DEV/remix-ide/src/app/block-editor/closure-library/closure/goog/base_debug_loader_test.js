...
FakeDependencyFactory.prototype.createDependency = function(
  ...
  realDependencies.push(
    this.realFactory.createDependency(
      path,
      relativePath,
      provides,
      requires,
...
function testLoadInNonHtmlNotThrows() {
  ...
  try {
    ...
    goog.addDependency(
      "loadInNonHtmlNotThrows",
      ["load.InNonHtmlNotThrows"],
      []
    )
...
function testAddDependencyModule() {
  ...
  require("testDep.mod")
  assertLoaded(0)
  assertDepData(realDependencies[0], "mod.js", ["testDep.mod"], [], {
    module: "goog"
  })
  ...
  assertLoaded(2)
  assertDepData(realDependencies[2], "mod-goog.js", ["testDep.goog"], [], {
    module: "goog"
  })
...
function testAddDependencyEs6Module() {
  ...
  require("testDep.es6")
  assertLoaded(0)
  assertDepData(realDependencies[0], "mod-es6.js", ["testDep.es6"], [], {
    module: "es6"
  })
  assertTrue(
...
function testAddDependencyTranspile() {
  ...
  goog.addDependency("fancy.js", ["testDep.fancy"], [], {
    lang: "es6-impl",
    module: "goog"
  })
