...
class SourceHighlighter {
  ...
  currentSourceLocation(lineColumnPos, location) {
    if (this.statementMarker)
      this._deps.editor.removeMarker(this.statementMarker, this.source)
    if (this.fullLineMarker)
      this._deps.editor.removeMarker(this.fullLineMarker, this.source)
  ...
  currentSourceLocationFromfileName(lineColumnPos, filePath, style) {
    ...
    if (lineColumnPos) {
      ...
      var css = csjs`
        .highlightcode {
          ...
          background-color: ${style ||
            styles.editor.backgroundColor_DebuggerMode};
        }
      ...
      this.statementMarker = this._deps.editor.addMarker(
        lineColumnPos,
        this.source,
        css.highlightcode
      )
      this._deps.editor.scrollToLine(
