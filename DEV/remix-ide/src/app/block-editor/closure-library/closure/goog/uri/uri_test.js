...
function testUriParseAcceptsThingsWithToString() {
  ...
  assertEquals(
    "http://www.google.com:80/path?q=query#fragmento",
    uri.toString()
  )
}
...
function testUriCreate() {
  assertEquals(
    ...
    goog.Uri.create(
      ...
      81,
      "/search path",
      new goog.Uri.QueryData().set("q", "what to eat+drink?"),
      null
    ).toString()
  )
...
function testAbsolutePathResolution() {
  ...
  assertEquals(
    ...
    goog.Uri.resolve(
      "http://www.google.com:8080/search/",
      "/foo/bar"
    ).toString()
  )
...
function testFragmentResolution() {
  assertEquals(
    ...
    goog.Uri.resolve("http://www.google.com/foo/bar?q=hi", "#there").toString()
  )

  assertEquals(
    "http://www.google.com/foo/bar?q=hi#there",
    goog.Uri.resolve(
      "http://www.google.com/foo/bar?q=hi#you",
      "#there"
    ).toString()
  )
}
...
function testParameterGetters() {
  ...
  assertArraysEqual(
    ["v1", "v2"],
    goog.Uri.parse(
      "/path?a=b&key=v1&c=d&key=v2&keywithsuffix=v3"
  ...
  assertEquals(
    "v1",
    goog.Uri.parse(
      "/path?key=v1&c=d&keywithsuffix=v3&key=v2"
  ...
  assertArraysEqual(
    ["v1", "v2"],
    goog.Uri.parse(
      "/path?key=v1&c=d&key=v2&keywithsuffix=v3"
    ).getParameterValues("key")
  )
  assertArraysEqual(
    ["v1", "v2"],
  ...
  // test no =
  assertArraysEqual([""], goog.Uri.parse("/path?key").getParameterValues("key"))
  assertArraysEqual(
    [""],
  ...
  assertEquals("", goog.Uri.parse("/path?foo=bar&key").getParameterValue("key"))
  assertEquals(
    "",
...
function testSetScheme() {
  ...
  assertEquals(
    "https://www.google.com:80/path?q=query#fragmento",
    uri.toString()
  )
  ...
  assertEquals(
    "ab%20cd://www.google.com:80/path?q=query#fragmento",
    uri.toString()
  )
...
function testSetDomain() {
  ...
  assertEquals(
    "http://%E1%B8%A1oogle.com:80/path?q=query#fragmento",
    uri.toString()
  )
...
function testSetPort() {
  ...
  assertEquals(
    "http://www.google.com:443/path?q=query#fragmento",
    uri.toString()
  )
...
function testSetUserInfo() {
  ...
  assertEquals(
    "http://user@www.google.com:80/path?q=query#fragmento",
    uri.toString()
  )
...
function testQueryDataCreateFromKeysValues() {
  ...
  assertEquals(
    "a=A&b=B&c=C",
    String(
      goog.Uri.QueryData.createFromKeysValues(["a", "b", "c"], ["A", "B", "C"])
    )
  )
  assertEquals(
    "a=A&a=B&a=C",
    String(
      goog.Uri.QueryData.createFromKeysValues(["a", "a", "a"], ["A", "B", "C"])
    )
  )
}
