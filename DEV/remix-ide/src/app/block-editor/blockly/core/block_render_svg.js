...
Blockly.BlockSvg.TAB_PATH_DOWN_HIGHLIGHT_RTL =
  "v 6.5 m -" +
  Blockly.BlockSvg.TAB_WIDTH * 0.97 +
  ",3 q -" +
  Blockly.BlockSvg.TAB_WIDTH * 0.05 +
  ",10 " +
  Blockly.BlockSvg.TAB_WIDTH * 0.3 +
  ",9.5 m " +
  Blockly.BlockSvg.TAB_WIDTH * 0.67 +
  ",-1.9 v 1.4"
...
Blockly.BlockSvg.prototype.renderCompute_ = function(iconWidth) {
  ...
  inputRows.statementEdge =
    2 * Blockly.BlockSvg.SEP_SPACE_X + fieldStatementWidth
  ...
  if (hasValue) {
    ...
    inputRows.rightEdge = Math.max(
      inputRows.rightEdge,
      fieldValueWidth + Blockly.BlockSvg.SEP_SPACE_X * 2
    )
  }
...
Blockly.BlockSvg.prototype.setPaths_ = function(pathObject) {
  var pathString =
    pathObject.steps.join(" ") + "\n" + pathObject.inlineSteps.join(" ")
  this.svgPath_.setAttribute("d", pathString)
  this.svgPathDark_.setAttribute("d", pathString)

  pathString =
    pathObject.highlightSteps.join(" ") +
    "\n" +
...
Blockly.BlockSvg.prototype.renderDrawRight_ = function(
  ...
  for (var y = 0, row; (row = inputRows[y]); y++) {
    ...
    pathObject.highlightSteps.push(
      "M",
      inputRows.rightEdge - 0.5 + "," + (cursor.y + 0.5)
    )
    if (this.isCollapsed()) {
...
Blockly.BlockSvg.prototype.renderDrawLeft_ = function(pathObject) {
  ...
  if (this.outputConnection) {
    ...
    if (this.RTL) {
      ...
      highlightSteps.push(
        "m",
        Blockly.BlockSvg.TAB_WIDTH * -0.92 +
          ",-0.5 q " +
          Blockly.BlockSvg.TAB_WIDTH * -0.19 +
          ",-5.5 0,-11"
      )
      highlightSteps.push(
        "m",
        Blockly.BlockSvg.TAB_WIDTH * 0.92 + ",1 V 0.5 H 1"
      )
    }
 ...
 * @private
 */
Blockly.BlockSvg.prototype.renderJaggedEdge_ = function(
  pathObject,
  row,
  cursor
) {
 ...
 * @private
 */
Blockly.BlockSvg.prototype.renderInlineRow_ = function(
  pathObject,
  row,
  cursor,
  connectionPos,
  ...
  for (var x = 0, input; (input = row[x]); x++) {
    ...
    if (input.type == Blockly.INPUT_VALUE) {
      ...
      if (this.RTL) {
        ...
        highlightInlineSteps.push(
          "h",
          Blockly.BlockSvg.TAB_WIDTH - 2 - input.renderWidth
        )
...
Blockly.BlockSvg.prototype.renderExternalValueInput_ = function(
  ...
  if (this.RTL) {
    ...
    highlightSteps.push(
      "M",
      rightEdge - 5 + "," + (cursor.y + Blockly.BlockSvg.TAB_HEIGHT - 0.7)
    )
    highlightSteps.push("l", Blockly.BlockSvg.TAB_WIDTH * 0.46 + ",-2.1")
  }
 ...
 * @private
 */
Blockly.BlockSvg.prototype.renderDummyInput_ = function(
  pathObject,
  row,
  cursor,
  rightEdge,
 ...
 * @private
 */
Blockly.BlockSvg.prototype.renderStatementInput_ = function(
  pathObject,
  row,
  cursor,
  connectionPos,
