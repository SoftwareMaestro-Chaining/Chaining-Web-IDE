...
goog.ui.ButtonRenderer.prototype.decorate = function(button, element) {
  ...
  element = goog.ui.ButtonRenderer.superClass_.decorate.call(
    this,
    button,
    element
  )
...
goog.ui.ButtonRenderer.prototype.setCollapsed = function(button, sides) {
  ...
  var collapseLeftClassName = goog.getCssName(
    this.getStructuralCssClass(),
    "collapse-left"
  )
  var collapseRightClassName = goog.getCssName(
    this.getStructuralCssClass(),
    "collapse-right"
  )
