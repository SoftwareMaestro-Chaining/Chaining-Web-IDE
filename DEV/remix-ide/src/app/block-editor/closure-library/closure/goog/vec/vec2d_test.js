...
function testMultiply() {
  ...
  goog.vec.vec2d.componentMultiply(
    goog.vec.vec2d.componentMultiply(v0, v1, v2),
    v0,
    v2
  )
...
function testDivide() {
  ...
  goog.vec.vec2d.componentDivide(
    goog.vec.vec2d.componentDivide(v1, v0, v2),
    v0,
    v2
  )
...
function testNormalize() {
  ...
  goog.vec.vec2d.scale(v0, 1 / goog.vec.vec2d.magnitude(v0), v2)
...
function testLerp() {
  ...
  goog.vec.vec2d.lerp(v0, v1, 0.5, v2)
