...
AppController.prototype.formatBlockLibraryForImport_ = function(xmlText) {
  ...
  for (var i = 0, blockNode; (blockNode = inputChildren[i]); i++) {
    ...
    // main workspace.
    // Create DOM for XML.
    var editorWorkspaceXml = document.createElementNS(
...
AppController.prototype.onTab = function() {
  ...
  if (
    ...
    var hasUnsavedChanges = !FactoryUtils.savedBlockChanges(
...
AppController.prototype.assignBlockFactoryClickHandlers = function() {
  ...
  document
    ...
    .addEventListener("click", function() {
      ...
      var proceedWithUnsavedChanges = self.blockLibraryController.warnIfUnsavedChanges()
...
AppController.prototype.init = function() {
  ...
  if (!window.goog.dom.xml) {
    alert(
      "Sorry: Closure dependency not found. We are working on removing " +
