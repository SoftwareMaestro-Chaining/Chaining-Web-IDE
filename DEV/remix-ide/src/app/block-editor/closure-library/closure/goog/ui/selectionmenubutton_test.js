...
function setUp() {
  clonedSelectionMenuButtonDom = goog.dom
    .getElement("demoSelectionMenuButton")
    .cloneNode(true)
...
function testBasicButtonBehavior() {
  ...
  assertFalse(
    "Menu must close on clicking when open",
...
function testCheckboxClickMenuClosed() {
  ...
  goog.testing.events.fireClickSequence(checkbox)
  assertFalse(
    "Menu must close when clickin checkbox",
    selectionMenuButton.isOpen()
  )
}
