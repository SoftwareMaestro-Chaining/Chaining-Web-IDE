...
BlockExporterController.prototype.export = function() {
  ...
  var generatorStub_filename = document.getElementById("generatorStub_filename")
    .value
  ...
  if (wantBlockDef) {
    ...
    if (!blockDef_filename) {
      ...
      var blockDefs = this.tools.getBlockDefinitions(
        blockXmlMap,
        definitionFormat
      )
 ...
 */
BlockExporterController.prototype.setUsedBlockTypes = function(usedBlockTypes) {
