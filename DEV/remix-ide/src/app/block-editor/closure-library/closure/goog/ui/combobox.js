...
goog.ui.ComboBox.prototype.onDocClicked_ = function(e) {
  if (
    !goog.dom.contains(this.menu_.getElement(), /** @type {Node} */ (e.target))
  ) {
    this.dismiss()
  }
}
...
goog.ui.ComboBox.prototype.onMenuSelected_ = function(e) {
  ...
  if (
    this.dispatchEvent(
      new goog.ui.ItemEvent(goog.ui.Component.EventType.ACTION, this, item)
    )
  ) {
...
goog.ui.ComboBox.prototype.handleInputChange_ = function() {
  ...
  if (
    goog.dom.getActiveElement(this.getDomHelper().getDocument()) == this.input_
  ) {
...
goog.ui.registry.setDecoratorByClassName(
  goog.getCssName("goog-combobox-item"),
  function() {
