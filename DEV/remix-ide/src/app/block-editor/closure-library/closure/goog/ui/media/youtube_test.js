...
function testParsingUrl() {
  ...
  assertExtractsCorrectly(
    "uddeBVmKTqE",
    "http://www.youtube-nocookie.com/watch?v=uddeBVmKTqE"
  )
  // a simple /embed/ link
  assertExtractsCorrectly(
    "uddeBVmKTqE",
    "http://www.youtube.com/embed/uddeBVmKTqE?controls=0"
  )
...
function testBuildingUrl() {
  assertEquals(
    YOUTUBE_URL,
    goog.ui.media.YoutubeModel.buildUrl(YOUTUBE_VIDEO_ID)
  )
}
