...
Blockly.PHP["lists_repeat"] = function(block) {
  ...
  var functionName = Blockly.PHP.provideFunction_("lists_repeat", [
...
Blockly.PHP["lists_length"] = function(block) {
  ...
  var functionName = Blockly.PHP.provideFunction_("length", [
...
Blockly.PHP["lists_setIndex"] = function(block) {
  ...
  var where = block.getFieldValue("WHERE") || "FROM_START"
  var value =
    Blockly.PHP.valueToCode(block, "TO", Blockly.PHP.ORDER_ASSIGNMENT) || "null"
...
Blockly.PHP["lists_getSublist"] = function(block) {
  ...
  if (where1 == "FIRST" && where2 == "LAST") {
    ...
    var functionName = Blockly.PHP.provideFunction_("lists_get_sublist", [
      "function " +
        Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ +
...
Blockly.PHP["lists_sort"] = function(block) {
  ...
  var functionName = Blockly.PHP.provideFunction_("lists_sort", [
    "function " +
      Blockly.PHP.FUNCTION_NAME_PLACEHOLDER_ +
      "($list, $type, $direction) {",
    "  $sortCmpFuncs = array(",
...
Blockly.PHP["lists_split"] = function(block) {
  ...
  var value_input = Blockly.PHP.valueToCode(
    block,
    "INPUT",
