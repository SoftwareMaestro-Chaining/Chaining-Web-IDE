...
function testConstructor() {
  assertNotNull(
    "ButtonRenderer singleton instance must not be null",
    buttonRenderer
  )
}
...
function testCreateDom() {
  ...
  assertEquals(
    "Element must have expected title",
    "Hello, world!",
    element.title
  )
  assertUndefined("Element must have no value", element.value)
  assertEquals(
    "Element must have expected contents",
    "Hello",
    element.innerHTML
  )
...
function testDecorate() {
  ...
  assertEquals(
    "bar's tooltip must be initialized",
    "Hello, world!",
    bar.getTooltip()
  )
  bar.dispose()
...
function testUpdateAriaState() {
  var element = buttonRenderer.createDom(button)
  buttonRenderer.updateAriaState(element, goog.ui.Component.State.CHECKED, true)
  assertEquals(
