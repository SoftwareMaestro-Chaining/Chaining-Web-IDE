 ...
 * @private
 */
goog.ui.SplitPane.FIRST_CONTAINER_CLASS_NAME_ = goog.getCssName(
 ...
 * @private
 */
goog.ui.SplitPane.SECOND_CONTAINER_CLASS_NAME_ = goog.getCssName(
 ...
 * @private
 */
goog.ui.SplitPane.HANDLE_CLASS_NAME_VERTICAL_ = goog.getCssName(
...
goog.ui.SplitPane.prototype.createDom = function() {
  ...
  var splitterHandle = dom.createDom(
    goog.dom.TagName.DIV,
...
goog.ui.SplitPane.prototype.finishSetup_ = function() {
  ...
  this.splitDragger_ = new goog.fx.Dragger(
...
goog.ui.SplitPane.prototype.snapIt_ = function() {
  ...
  var firstBorderBoxSize = goog.style.getBorderBoxSize(
    this.firstComponentContainer_
  )
  var firstContentBoxSize = goog.style.getContentBoxSize(
    this.firstComponentContainer_
  )
...
goog.ui.SplitPane.prototype.handleDragStart_ = function(e) {
  ...
  var secondContentBoxSize = goog.style.getContentBoxSize(
    this.secondComponentContainer_
  )
  if (this.isVertical()) {
