...
Blockly.Lua["lists_repeat"] = function(block) {
  ...
  var functionName = Blockly.Lua.provideFunction_("create_list_repeated", [
...
Blockly.Lua["lists_sort"] = function(block) {
  ...
  var functionName = Blockly.Lua.provideFunction_("list_sort", [
    "function " +
      Blockly.Lua.FUNCTION_NAME_PLACEHOLDER_ +
...
Blockly.Lua["lists_reverse"] = function(block) {
  ...
  var list =
    Blockly.Lua.valueToCode(block, "LIST", Blockly.Lua.ORDER_NONE) || "{}"
  var functionName = Blockly.Lua.provideFunction_("list_reverse", [
