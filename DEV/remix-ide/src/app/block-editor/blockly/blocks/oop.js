...
Blockly.Blocks["field_get"] = {
  ...
  init: function() {
    ...
    this.fieldFieldref_ = new Blockly.FieldFieldref(function(e) {
      ...
      var field = fields.filter(function(e) {
...
Blockly.Blocks["oop_variables_set"] = {
  ...
  init: function() {
    ...
    this.appendValueInput("VALUE")
      ...
      .appendField("of type")
      .appendField(
        new Blockly.FieldType(function(type) {
...
Blockly.Blocks["oop_procedures_defnoreturn"] = {
  ...
  decompose: function(workspace) {
    ...
    var names = this.arguments_.map(function(e) {
      return e.name
    })
    ...
    if (change) {
      ...
      if (this.mutator.isVisible()) {
        ...
        for (var i = 0, block; (block = blocks[i]); i++) {
          if (
            block.type == "oop_procedures_mutatorarg" &&
...
Blockly.Blocks["oop_procedures_defreturn"] = {
  ...
  customContextMenu:
    Blockly.Blocks["oop_procedures_defnoreturn"].customContextMenu,
...
Blockly.Blocks["oop_procedures_mutatorcontainer"] = {
  ...
  init: function() {
    ...
    this.getInput("STATEMENT_INPUT").appendField(
      new Blockly.FieldType(),
      "TYPE"
    )
  }
}
