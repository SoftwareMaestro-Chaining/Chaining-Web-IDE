...
goog.scope(function() {
   ...
   */
  goog.ui.Bubble.prototype.getComputedAnchoredPosition = function(
    anchorElement
  ) {
  ...
  goog.ui.Bubble.prototype.computePinnedCorner_ = function(anchorElement) {
    ...
    if (
      viewportWidth - anchorElementOffset.x - anchorElementSize.width >
    ...
    if (
      viewportHeight - anchorElementOffset.y - anchorElementSize.height >
  ...
  goog.ui.Bubble.defaultConfig = {
    ...
    cssBubbleBottomRightAnchor: goog.getCssName(
      "goog-bubble-bottom-right-anchor"
    ),
    cssBubbleBottomLeftAnchor: goog.getCssName(
