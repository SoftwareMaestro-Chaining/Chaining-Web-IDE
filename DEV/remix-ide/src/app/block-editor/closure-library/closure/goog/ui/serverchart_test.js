...
function testMinValue() {
  ...
  var line = new goog.ui.ServerChart(
...
function testSetParameterValue() {
  var scatter = new goog.ui.ServerChart(
...
function testBarChartRequest() {
  var bar = new goog.ui.ServerChart(goog.ui.ServerChart.ChartType.BAR, 180, 104)
  tryToCreateBarChart(bar)
...
function testSetMultiAxisLabelStyle() {
  ...
  assertEquals(
    noAlignArgs,
    noAlignUri.getParameterValue(goog.ui.ServerChart.UriParam.MULTI_AXIS_STYLE)
  )
...
function testGetConvertedValue() {
  ...
  assertEquals(
    "24",
    chart.getConvertedValue_(24, 1, 200, goog.ui.ServerChart.EncodingType.TEXT)
  )
  assertEquals(
    "H",
    chart.getConvertedValue_(
  ...
  assertEquals(
    "_",
    chart.getConvertedValue_(0, 1, 200, goog.ui.ServerChart.EncodingType.SIMPLE)
  )
  assertEquals(
    "_",
    chart.getConvertedValue_(
  ...
  assertEquals(
    "_",
    chart.getConvertedValue_(0, 1, 200, goog.ui.ServerChart.EncodingType.TEXT)
  )
  assertEquals(
    "_",
    chart.getConvertedValue_(201, 1, 200, goog.ui.ServerChart.EncodingType.TEXT)
  )
}
...
function testUriLengthLimit() {
  ...
  var longUri = null
  goog.events.listen(chart, goog.ui.ServerChart.Event.URI_TOO_LONG, function(
    e
  ) {
    longUri = e.uri
  })
