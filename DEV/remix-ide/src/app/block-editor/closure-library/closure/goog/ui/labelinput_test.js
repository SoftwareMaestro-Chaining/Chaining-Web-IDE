...
function assertLabelValue(labelInput, expectedLabel) {
  assertEquals(
    ...
    expectedLabel,
    goog.a11y.aria.getState(labelInput.getElement(), goog.a11y.aria.State.LABEL)
  )
...
function testDecorateElementWithFocusDelay() {
  ...
  // testClassName() below.
  goog.testing.events.fireBrowserEvent(
    new goog.testing.events.Event(goog.events.EventType.BLUR, decoratedElement)
  )
